...
*/	
	...
	removeBarriers = {
		...
		Barrier1 = player addaction [("<t color=""#00ced1"">" + ("Barreira 1.") +"</t>"),{call placeBarriers;},["Land_CncBarrier_stripes_F"],0.1,false,true,"","vehicle player == player"];
		Barrier2 = player addaction [("<t color=""#00ced1"">" + ("Barreira 2.") +"</t>"),{call placeBarriers;},["Land_PlasticBarrier_03_F"],0.1,false,true,"","vehicle player == player"];	
		Barrier3 = player addaction [("<t color=""#00ced1"">" + ("Cone com Luz.") +"</t>"),{call placeBarriers;},["RoadCone_L_F"],0.1,false,true,"","vehicle player == player"];
		Barrier4 = player addaction [("<t color=""#00ced1"">" + ("Barricada.") +"</t>"),{call placeBarriers;},["RoadBarrier_F"],0.1,false,true,"","vehicle player == player"];
		Barrier5 = player addaction [("<t color=""#00ced1"">" + ("Barricada Pequena com Luz.") +"</t>"),{call placeBarriers;},["RoadBarrier_small_F"],0.1,false,true,"","vehicle player == player"];	
		Barrier6 = player addaction [("<t color=""#00ced1"">" + ("Barricada c/ Cancela.") +"</t>"),{call placeBarriers;},["Land_BarGate_F"],0.1,false,true,"","vehicle player == player"];	
		Barrier8 = player addaction [("<t color=""#0066d1"">" + ("Colocar.") +"</t>"),{detach placeable; placeable setVectorUP (surfaceNormal [(getPosATL placeable) select 0,(getPosATL placeable) select 1]);},[""],0.1,false,true,"","vehicle player == player"];
		Barrier9 = player addaction [("<t color=""#0066d1"">" + ("Deletar todos.") +"</t>"),{call removeBarriers},[""],0.1,false,true,"","vehicle player == player"];
