...
if (isNil {IL_Green_Text}) then { IL_Green_Text = "<t color='#00FF00'>Mudar a luz para verde</t>"; };
if (isNil {IL_Red_Text}) then { IL_Red_Text = "<t color='#FF0000'>Mudar a luz para vermelho</t>"; };
